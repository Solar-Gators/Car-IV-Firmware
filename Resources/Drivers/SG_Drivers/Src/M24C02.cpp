...
HAL_StatusTypeDef M24C02_ReadRegister(M24C02 *dev, uint8_t reg, uint8_t *data, uint8_t length){ //Function to read data off the EEPROM. Utilizes overloading.
...
HAL_StatusTypeDef M24C02_WriteRegister(M24C02 *dev, uint8_t reg, uint8_t *data, uint8_t length){ //Function to write data to the EEPROM. Utilizes overloading.
