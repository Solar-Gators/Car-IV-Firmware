...
static int32_t local_pack_voltage; // Voltage of pack voltage measured by this BMS in mV
static int32_t total_pack_voltage; // Voltage of pack voltage measured by all BMS in mV
static int16_t high_cell_voltage = INT16_MIN;
static int16_t low_cell_voltage = INT16_MAX;
static int8_t high_cell_voltage_id = 0;
static int8_t low_cell_voltage_id = 0;
static int16_t avg_cell_voltage;
