...
/* Private defines -----------------------------------------------------------*/
#define BMS_ALERT_Pin GPIO_PIN_2
#define BMS_ALERT_GPIO_Port GPIOC
#define BMS_RST_SHUT_Pin GPIO_PIN_3
#define BMS_RST_SHUT_GPIO_Port GPIOC
#define ERROR_LED_Pin GPIO_PIN_0
#define ERROR_LED_GPIO_Port GPIOA
#define OK_LED_Pin GPIO_PIN_1
#define OK_LED_GPIO_Port GPIOA
#define CONTACTOR1_CTRL_Pin GPIO_PIN_5
#define CONTACTOR1_CTRL_GPIO_Port GPIOA
#define CONTACTOR2_CTRL_Pin GPIO_PIN_6
#define CONTACTOR2_CTRL_GPIO_Port GPIOA
...
#define CONTACTOR4_CTRL_Pin GPIO_PIN_5
#define CONTACTOR4_CTRL_GPIO_Port GPIOC
#define CONTACTOR3_CTRL_Pin GPIO_PIN_0
#define CONTACTOR3_CTRL_GPIO_Port GPIOB
...
#define NWC_Pin GPIO_PIN_10
#define NWC_GPIO_Port GPIOA
