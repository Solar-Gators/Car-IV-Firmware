...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, ERROR_LED_Pin|OK_LED_Pin|MIO1_Pin|MIO2_Pin
                          |AMP_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ERROR_LED_Pin OK_LED_Pin MIO1_Pin MIO2_Pin
                           AMP_EN_Pin */
  GPIO_InitStruct.Pin = ERROR_LED_Pin|OK_LED_Pin|MIO1_Pin|MIO2_Pin
                          |AMP_EN_Pin;
  ...
  /*Configure GPIO pin : CONTACTOR_SOURCE_ST_Pin */
  GPIO_InitStruct.Pin = CONTACTOR_SOURCE_ST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(CONTACTOR_SOURCE_ST_GPIO_Port, &GPIO_InitStruct);
